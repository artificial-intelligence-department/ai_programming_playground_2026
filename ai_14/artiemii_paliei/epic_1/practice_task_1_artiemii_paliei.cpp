...
int main()
{
    ...
    {
        std::cout << "Вік станції повинен бути числом або в діапазоні від 0 до 20 років" << std::endl;
        return 1;
    }
    ...
    {
        std::cout << "Заряд станції повинен бути числом або в діпазоні від 0 до 100%" << std::endl;
        return 1;
    }
    ...
    {
        std::cout << "ККД зарядної станції повинен бути числом або в діапазоні від 0 до 100" << std::endl;
        return 1;
    }
