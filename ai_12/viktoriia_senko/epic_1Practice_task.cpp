...
#include <locale> //для адаптації програми під певну мову
using namespace std;
int main() {
    ...
    double c_eff=c*pow(1.0-(Battery_Degradation/100), years); 
